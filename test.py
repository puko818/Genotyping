...
# Decide which chromosomes to use - !!!replace by sample list
#chromosome_list = ['chr%s' % i for i in range(1, 23) + ['M', 'X', 'Y']]
#chromosome_list = ['470_1 egg.GType:7']
chromosome_list=["470_1 egg.GType:7"]
...
color_lookup = {
     -1: (0.502, 0.502, 0.502),#gray
     -9: (1., 1., 1.),#white
     4: (1.000, 0.000, 0.000),#red
     3: (1.000, 0.647, 0.000),#orange
     6: (0.000, 0.502, 0.000),#green
     0: (1.000, 0.647, 0.000),#orange
     9: (0.000, 0.502, 0.000)#green
}
